  ...
  // MobileCal does the same thing.
	if([eMobcViewController isIPad]){
		if([[UIDevice currentDevice]orientation] == UIInterfaceOrientationLandscapeLeft || [[UIDevice currentDevice]orientation] == UIInterfaceOrientationLandscapeRight){
			frame.size.width = 7 * kTileSizeIPadLandscape.width;	
		}else{
			frame.size.width = 7 * kTileSizeIPad.width;
		}	
		
	}else{
		if([[UIDevice currentDevice]orientation] == UIInterfaceOrientationLandscapeLeft || [[UIDevice currentDevice]orientation] == UIInterfaceOrientationLandscapeRight){
			frame.size.width = 7 * kTileSizeLandscape.width;	
		}else{
  ...
  if (direction == SLIDE_UP) {
	  if([eMobcViewController isIPad]){
		  if([[UIDevice currentDevice]orientation] == UIInterfaceOrientationLandscapeLeft || [[UIDevice currentDevice]orientation] == UIInterfaceOrientationLandscapeRight){
			  ...
			  ? frontMonthView.bottom - kTileSizeIPadLandscape.height
			  : frontMonthView.bottom;	
		  }else{
			  backMonthView.top = keepOneRow
			  ? frontMonthView.bottom - kTileSizeIPad.height
			  : frontMonthView.bottom;
		  }	
	  }else{
		  if([[UIDevice currentDevice]orientation] == UIInterfaceOrientationLandscapeLeft || [[UIDevice currentDevice]orientation] == UIInterfaceOrientationLandscapeRight){
			  backMonthView.top = keepOneRow
			  ? frontMonthView.bottom - kTileSizeLandscape.height
			  : frontMonthView.bottom;	
		  }else{
			  backMonthView.top = keepOneRow
    ...
    NSInteger numWeeksToSlide = [backMonthView numWeeks] - numWeeksToKeep;
	  ...
	  if([eMobcViewController isIPad]){
		  if([[UIDevice currentDevice]orientation] == UIInterfaceOrientationLandscapeLeft || [[UIDevice currentDevice]orientation] == UIInterfaceOrientationLandscapeRight){
			  backMonthView.top = -numWeeksToSlide * kTileSizeIPadLandscape.height;	
		  }else{
			  backMonthView.top = -numWeeksToSlide * kTileSizeIPad.height;
		  }	
	  }else{
		  if([[UIDevice currentDevice]orientation] == UIInterfaceOrientationLandscapeLeft || [[UIDevice currentDevice]orientation] == UIInterfaceOrientationLandscapeRight){
			  backMonthView.top = -numWeeksToSlide * kTileSizeLandscape.height;
		  }else{
